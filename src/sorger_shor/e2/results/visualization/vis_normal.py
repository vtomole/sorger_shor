...
all_odd_composite_numbers = sorted(odd_composite_numbers_normal | odd_composite_numbers_times_normal)
...
all_times = [time for sublist in times_normal_values for time in sublist if time is not None]
